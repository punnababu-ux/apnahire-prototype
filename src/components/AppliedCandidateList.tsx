      ...
      <div className="bg-white border border-[#dfe1e6] rounded-xl px-4 pt-3 pb-4 mb-3 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          {[
            ...
            { label: 'Viewed number',  value: viewed,      active: false },
      ...
      {highMatches.length > 0 && (
        <div className="border border-purple-200 rounded-xl bg-purple-50/40 mb-3 overflow-hidden">
          <div className="px-4 py-3">
            ...
            <p className="text-xs text-gray-400 mt-0.5 ml-6">Candidates matching all your key requirements. Connect with them before someone else does!</p>
          </div>
      ...
      <div className="px-6 pt-4 pb-4 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <button className="w-10 h-10 flex items-center justify-center border border-[#dfe1e6] rounded-xl hover:bg-gray-50">
