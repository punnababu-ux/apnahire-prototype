  ...
  return (
    <header className="topbar">
      <button
        ...
        onClick={toggle}
      >
        <span className="material-icons-round text-[22px] select-none">menu</span>
      </button>
      ...
      <div className="topbar-right">
        <button
          ...
          aria-label={`${credits.toLocaleString()} credits available`}
        ...
        >
          ...
          <span className="available-credit-label">Buy credits</span>
        </button>
