...
const STEPS = [
  {
    accent: '#1a56db',
    accentLight: '#dbeafe',
    title: 'Introducing Hot Leads from apna database',
  ...
  },
  {
    ...
    body: 'Hot Leads have recently applied to similar jobs and match your key requirements.',
    preview: 'respond',
    cta: 'Next',
  },
  {
        ...
        <div className="px-8 pt-6 pb-8">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              style={{ background: current.accent }}
            >
              {step === STEPS.length - 1 ? (hasCredits ? 'See all Hot Leads' : 'View Hot Leads') : 'Next'}
            </button>
          </div>
        </div>
      </div>
